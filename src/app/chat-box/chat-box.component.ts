...
export class ChatBoxComponent implements OnInit {
  ...
  friends = [
    { firstName: 'Joel', lastName: 'Miller', status: EnumStatusOnline.DoNotDisturb, avatar: 'https://firebasestorage.googleapis.com/v0/b/yap-web-27230.firebasestorage.app/o/avatars%2Fjoelmiller053%40gmail.com.png?alt=media&token=ca1e8caf-c955-4877-8494-8ba04967c8d9' },
    { firstName: 'Nathan', lastName: 'Drake', status: EnumStatusOnline.Online, avatar: 'https://firebasestorage.googleapis.com/v0/b/yap-web-27230.firebasestorage.app/o/avatars%2Frigbybaby123%40gmail.com.png?alt=media&token=e1ac95d3-b8fd-46e6-b240-192ab7401bbf' }
  ];
  conversations = [
    { conversationId: '1', 
